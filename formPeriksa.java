  ...
  private void form_enable(){
    ...
    private void koneksitabel (){
        try {
            ...
            JOptionPane.showMessageDialog(null, "SELAMAT DATANG Di RS UNISA");
 ...
 private void tampildetailpemeriksaan(String sql){
  DefaultTableModel datalist = new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(120, 208, 145));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ikon0/logo-unisa-500px-removebg-preview.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-140, 0, 330, 130));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ikon0/Logo Prodi.png"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 10, 390, 140));

        jLabel3.setFont(new java.awt.Font("Candara", 1, 48)); // NOI18N
        jLabel3.setText("Rumah Sakit UNISA YK");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, 510, 80));

        jLabel4.setFont(new java.awt.Font("Yu Gothic", 1, 12)); // NOI18N
        jLabel4.setText("Siap Melayani Anda 24 Jam");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, 176, 20));

        jLabel5.setFont(new java.awt.Font("Yu Gothic", 1, 12)); // NOI18N
        jLabel5.setText("Jl. Ringroad Barat No.63,  Sleman, DI Yogyakarta");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, -1, 20));

        jLabel6.setFont(new java.awt.Font("Yu Gothic", 1, 12)); // NOI18N
        jLabel6.setText("No Telp 08892290002");
        ...
        Cmb_kodeobat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Cmb_kodeobatActionPerformed(evt);
            }
        });
        ...
        jPanel1.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 250, 140, 20));
        ...
        Txt_jumlahtotal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Txt_jumlahtotalActionPerformed(evt);
            }
        });
    ...
    private void Btn_SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_SimpanActionPerformed
        ...
        kodeobat=Cmb_kodeobat.getItemAt(Cmb_kodeobat.getSelectedIndex());
    ...
    private void Cmb_kodeobatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Cmb_kodeobatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Cmb_kodeobatActionPerformed
    ...
    private void Txt_jumlahtotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Txt_jumlahtotalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Txt_jumlahtotalActionPerformed
